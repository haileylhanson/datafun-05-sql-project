'''Create a Python script that demonstrates the ability to run sql scripts to interact with fields, 
update records, 
delete records, 
and maybe add additional columns.'''
"""
...
def main() -> None:
    ...
    DB_PATH = DATA_FOLDER.joinpath('db.sqlite3') #changed from .sqlite to .sqlite3
